...
//    var personnel_number = '';
    ...
    $('#datatables_finish').dataTable({
        ...
        switch(aData[6]){
            ...
            $('#totaldatafinish').html(record_count);
        },
   ...
   $('#datatables_high').dataTable({
        ...
        switch(aData[7]){
            ...
            var record_count = this.fnSettings().fnDisplayEnd();            
            $('#totaldatahigh').html(record_count); 
        },
    ...
    $('#datatables_normal').dataTable({
        ...
        switch(aData[6]){
            ...
            var record_count = this.fnSettings().fnDisplayEnd();            
            $('#totaldatanormal').html(record_count);
        },
        // Load data for the table's content from an Ajax source
        "ajax": {
            ...
            <tbody class="data-search-authorization-high">
                ...
                <tr class="text-authorization-high">
                    <td>
                        ...
                        <option value="status_approved_quality">Status Approved Quality</option>                                                
