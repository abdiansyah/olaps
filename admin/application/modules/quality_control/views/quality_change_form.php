    ...
    <div class="box-body">
            ...
            <div class="wizard-inner">
                ...
                <ul class="nav nav-tabs" role="tablist">            
                    ...
                    <?php
                    if($rc[0]->status_issue_authorization == 'Issue Authorization Finished'){
        ...
        <div class="col-md-12" id="dtl_to_atasan">           
            <div class="box-body table-responsive no-padding">
                ...
                <?php foreach($rc_assesment_history AS $value_assesment_history) :?>    
                    <tr>
        ...
        <?php } else if($aksi == "add") {?>
            ...
            <a class="btn btn-flat bg-red color-palette btn-sm" id="clear_remark"><span class="fa  fa-trash"></span>&nbsp;&nbsp;Clear Remark</a>
            <br/>
            <br/>            
            ...
            <a class="btn btn-flat bg-olive color-palette btn-sm" href="<?php echo $back_home_quality; ?>"><span class="fa  fa-arrow-left"></span>&nbsp;&nbsp;Back</a>
            </div>
            </div>
            <?php echo form_close(); ?>                    
        <?php } ?>                                                                         
...
$('#current_status').change(function(){            
    ...
    $.get("<?php echo base_url();?>index.php/quality_control/get_tab_option_sub_status/" + current_status + "/" + request_number, function(data, status){                 
...
$('#clear_remark').on('click',function(){
    $('[name=remark]').val('');
});
</script>
