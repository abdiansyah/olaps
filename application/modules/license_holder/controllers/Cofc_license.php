...
class Cofc_license extends MX_Controller {
	...
	public function __construct() {
		...
		$this->load->model('model_cofc_license');
	}
	
	public function index() {
		$this->page->view('cofc_license_index', array (
    ...
    public function ajax_cofc_license(){		    
		$list = $this->model_cofc_license->get_cofc_license();
		$data = array();
		$no = $_POST['start'];
		...
		$output = array(
			"draw" 				=> $_POST['draw'],
			"recordsTotal" 		=> $this->model_cofc_license->count_all_cofc_license(),
            "recordsFiltered" 	=> $this->model_cofc_license->count_filtered_cofc_license(),			
			"data" 				=> $data,            
		);
