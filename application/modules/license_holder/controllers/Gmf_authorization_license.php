...
class Gmf_authorization_license extends MX_Controller {
	...
	public function __construct() {
		...
		$this->load->model('model_gmf_authorization_license');
	}
	
	public function index() {
		$this->page->view('gmf_authorization_license_index', array (
			'add'		=> $this->page->base_url('/add')
		
		));
	}
	
    public function ajax_gmf_authorization_license(){		    
		$list = $this->model_gmf_authorization_license->get_gmf_authorization_license();
		$data = array();
		$no = $_POST['start'];
		...
		$output = array(
			"draw" 				=> $_POST['draw'],
			"recordsTotal" 		=> $this->model_gmf_authorization_license->count_all_gmf_authorization_license(),
            "recordsFiltered" 	=> $this->model_gmf_authorization_license->count_filtered_gmf_authorization_license(),			
			"data" 				=> $data,            
		);
