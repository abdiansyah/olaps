...
class Easa_license extends MX_Controller {
	...
	public function __construct() {
		...
		$this->load->model('model_easa_license');
	}
	
	public function index() {
		$this->page->view('easa_license_index', array (
			'add'		=> $this->page->base_url('/add')
		
		));
	}
	
    public function ajax_easa_license(){		    
		$list = $this->model_easa_license->get_easa_license();
		$data = array();
		$no = $_POST['start'];
		...
		$output = array(
			"draw" 				=> $_POST['draw'],
			"recordsTotal" 		=> $this->model_easa_license->count_all_easa_license(),
            "recordsFiltered" 	=> $this->model_easa_license->count_filtered_easa_license(),			
			"data" 				=> $data,            
		);
