...
$().ready(function(){
$('#datatables_customer_authorization_license').dataTable({
		"scrollY"         : "342px", 
    "searching"       : false, 
    "select"          : true,
    "bLengthChange"   : false,      
    ...
    "order"           : [], //Initial no order.     
		...
		"ajax": {
			"url"	: "<?php echo site_url('license_holder/customer_authorization_license/ajax_customer_authorization_license'); ?>",
			"type"	: "POST",                        
		},
...
<div class="row">
	<div class="col-sm-8 col-sm-offset-2 col-center-block table-responsive">    
		<div class="box box-info">
			<div class="box-header with-border">
				<h3 class="box-title">Customer License Holder</h3>
			</div>
			<div class="box-body">
    ...
    <table cellpadding="0" cellspacing="0" class="table table-bordered table-striped tabel_bootstrap" id="datatables_customer_authorization_license">
		<thead>			
            <tr>				
				<th width="20%">Name</th>                
                <th width="10%">Unit</th>
