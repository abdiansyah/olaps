...
$().ready(function(){
$('#datatables_gmf_authorization_license').dataTable({
		"scrollY"			    : "342px", 
    "searching"       : false, 
    "select"          : true,
    "bLengthChange"		: false,      
    ...
    "bPaginate"       : false,  
		...
		"ajax": {
			"url"	: "<?php echo site_url('license_holder/gmf_authorization_license/ajax_gmf_authorization_license'); ?>",
			"type"	: "POST",                        
		},
	...
	$('[name=ac_type],[name=customer]').select2({width : '20%'});
...
<div class="row">
	<div class="col-sm-8 col-sm-offset-2 col-center-block table-responsive">    
		<div class="box box-info">
			<div class="box-header with-border">
				<h3 class="box-title">GMF Authorization License Holder</h3>
			</div>
			<div class="box-body">
    ...
    <option>---</option>
    <?php 
    //echo modules::run('license_holder/gmf_authorization_license/option_ac_type'); 
    ?>   
    </select>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     	
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	
    ...
    <table cellpadding="0" cellspacing="0" class="table table-bordered table-striped tabel_bootstrap" id="datatables_gmf_authorization_license">
		<thead>			
            <tr>				
				<th width="20%">Name</th>                
                <th width="10%">Unit</th>
