  ...
  <div class="col-sm-8 col-sm-offset-2 col-center-block table-responsive">    
    <div class="box box-info">
      <div class="box-header with-border">
        <h3 class="box-title">AME License Holder</h3>
      </div>
      <div class="box-body">
    ...
    <table cellpadding="0" cellspacing="0" class="table table-bordered table-striped tabel_bootstrap" id="datatables_ame_license">
    <thead>     
       <tr>       
          <th width="20%">Name</th>                
          <th width="10%">Unit</th>
          <th width="10%">AME No.</th>                              
