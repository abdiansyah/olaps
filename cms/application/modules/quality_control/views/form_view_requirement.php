...
<iframe src="<?php echo "ftp://usr-olaps:p@ssw0rd@192.168.40.107/TQ-STORAGE/LICENSE_CERTIFICATION/OLAPS/".$personnel_number."/".$name_file_ftp; ?>"  height="600px" width="70%"></iframe>
<br/>
<br/>
<form action="<?php echo base_url()."index.php/quality_control/process_document"; ?>" method="post">            
<input type="hidden" name="request_number" value="<?php echo $request_number;?>" />
