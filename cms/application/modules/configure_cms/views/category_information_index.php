...
$().ready(function(){	  
	$('#datatables').dataTable({
		...
		"ajax": {
			"url"	: "<?php echo site_url('configure_cms/category_information/ajax_get_cat_inf'); ?>",
			"type"	: "POST"
		},
...
<section class="content-header">
	<h1>Category Information <small><i class="fa fa-fw fa-angle-double-right"></i> List Data</small></h1>
</section>
