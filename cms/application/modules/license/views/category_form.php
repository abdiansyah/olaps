...
<?php echo form_open($action, array('class' => 'form-horizontal row-form', 'data-toggle' => 'validator')); ?>
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label input-sm">Name category</label>
		<div class="col-sm-4">
		  <input class="form-control input-sm" type="text" name="name_t" id="inputName" placeholder="name"  required />
		</div>
	</div>
    <div class="form-group">
        <label class="col-sm-2 control-label input-sm">Keterangan</label>
		<div class="col-sm-4">
		  <input class="form-control input-sm" type="text" name="desc_t" id="inputName" placeholder="keterangan"   />
		</div>
	</div>
    <?php 
    endif;
