...
class Menu_management extends MX_Controller {
	...
	public function ajax_get_menu(){
		...
		foreach ($list as $grid) {			
			...
			$row[] = $grid->EMPLNAME;
			$row[] = '<a href="'.site_url('setting/menu_management/edit/'.$grid->id_menu).'" title="Edit Data"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
					<a class="red" href="'.site_url('setting/menu_management/delete/'.$grid->id_menu).'" onclick="return del_confirm(\''.$grid->nama.'\')" title="Delete Data"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>';
